  ...
  return (
    <nav>
      <div className='sideBarContainer'>
        <NavLink to='/home/users' className={({ isActive }) => (isActive ? 'active-text-link' : 'text-link')}>
          <UsersIcon className='sidebar-icon' />
          {isDesktopScreen && Entities.USERS}
        </NavLink>
        <NavLink to='/home/groups' className={({ isActive }) => (isActive ? 'active-text-link' : 'text-link')}>
          <GroupsIcon className='sidebar-icon' />
          {isDesktopScreen && Entities.GROUPS}
        </NavLink>

        <NavLink to='/home/roles' className={({ isActive }) => (isActive ? 'active-text-link' : 'text-link')}>
